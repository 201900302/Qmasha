...
<div class="bg-light py-3">
    <div class="container">
      <div class="row">
        <div class="col-md-12 mb-0"><a href="index.html">Home</a><span class="mx-2 mb-0">/</span> <strong class="text-black">All Products</strong></div>
      </div>
    </div>
  </div>
        ...
        <div class="col-md-9 order-2">
            ...
            <div class="row">
              <div class="col-md-12 mb-5">
                <div class="float-md-left mb-4"><h2 class="h5 text-black">All Products Results <span class="badge rounded-pill bg-secondary text-light">{{ count($products) }}</span></h2><hr></div>
...
@foreach ($products as $product)
        ...
        <div class="border p-4 rounded mb-4">
          ...
          <form action="{{route('shop.all.filter')}}" method="POST">
            @csrf
