...
<div class="bg-light py-3">
    <div class="container">
      <div class="row">
        <div class="col-md-12 mb-0"><a href="index.html">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">{{$subCategorySelected['category']['category_name']}}</strong><span class="mx-2 mb-0">/</span> <strong class="text-black">{{$subCategorySelected->subcategory_name}}</strong></div>
      </div>
    </div>
  </div>
    ...
    <div class="container" >
        <div class="boutiqueInfo">
          ...
          <div class="boutiqueTextInfo pl-4">
              ...
              <h3 class="pt-3" style="color: #926F34">{{$subCategorySelected->subcategory_name}} Collection</h3>
        ...
        <div class="col-md-9 order-2">
            ...
            <div class="row">
              <div class="col-md-12 mb-5">
                <div class="float-md-left mb-4"><h2 class="h5 text-black">Shop All {{$subCategorySelected->subcategory_name}} <span class="badge rounded-pill bg-secondary text-light">{{ count($products) }}</span></h2><hr></div>
