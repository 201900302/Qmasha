...
<div class="page-content"> 
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            ...
            <div class="btn-group">
            <a class="btn btn-info" href="{{ route('admin.selected.vendor.products',$vendorData->id) }}">View Products</a>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="boutique_form" method="POST" action="{{ route('deactive.boutique.approve') }}" enctype="multipart/form-data">
                                @csrf
