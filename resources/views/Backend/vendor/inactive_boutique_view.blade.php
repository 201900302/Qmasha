...
<div class="page-content"> 
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            ...
            <div class="btn-group">
                <button style="border-color: transparent; background-color:transparent;" type="submit" form="boutique_form" ><a class="btn btn-success">Activate</a></button>

            </div>
            <div class="btn-group">
                <button formaction="{{ route('reject.boutique.approve') }}" style="border-color: transparent; background-color:transparent;" type="submit" form="boutique_form" ><a class="btn btn-danger">Reject</a></button>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="boutique_form" method="POST" action="{{ route('active.boutique.approve') }}" enctype="multipart/form-data">
                                @csrf
